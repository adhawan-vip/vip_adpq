...
* g.  VIP used HTML and CSS in a manner that complies with the ADA and WCAG 2.0. Additionally, we tested our prototype for 508 compliance using open source tools and remediated any issues that would block a screen reader from using our prototype.
...
* l.  VIP used several modern and open-source technologies in development of our prototype. Please see [this link](https://github.com/adhawan-vip/vip_adpq/blob/master/docs/TechStack.MD) for our modern and open-source technologies used.
