...
import com.trustvip.service.mapper.UserMapper;
import com.trustvip.web.rest.errors.ExceptionTranslator;
import com.trustvip.web.rest.vm.ManagedUserVM;
...
public class UserResourceIntTest {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(containsInAnyOrder(AuthoritiesConstants.USER, AuthoritiesConstants.ADMIN, AuthoritiesConstants.AUTHOR, AuthoritiesConstants.REVIEWER)));
    }
